...
if (isset($_POST['submit'])) {
    ...
    $stmt->bind_param("ssiiiii", $studentregno, $pincode, $session, $dept, $level, $course, $sem);
    
    if ($stmt->execute()) {
        echo "<script>alert('Enroll Successfully !!'); window.location.href='enroll.php';</script>";
    } else {
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            ?>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="studentname" value="<?php echo htmlentities($row['studentName']); ?>" readonly />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="Pincode" value="<?php echo htmlentities($row['pincode']); ?>" readonly required />
                                </div>
